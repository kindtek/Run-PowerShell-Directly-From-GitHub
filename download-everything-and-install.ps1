...
do {
    ...
    if ($confirmation -eq '') {   
        ...
        Write-Host "`r`nChoose from the following:`r`n`t- [l]aunch default WSL distro`r`n`t- [i]mport Docker image as WSL distro`r`n`t- [s]etup Kindtek LINUX environment`r`n`t- [u]pdate Kindtek WINDOWS environment`r`n`r`n    (exit)`n"
