...
$dir_host_devels_workshop = "$PSScriptRoot/$repo_src_owner/$repo_src_name/$repo_src_branch"
$dir_host_devels_workshop_scripts = "$PSScriptRoot/$dir_host_devels_workshop/scripts"
$dir_host_devels_advocate = "$PSScriptRoot/$repo_src_owner/$devels_advocate/$repo_src_name"
$dir_host_devels_playground = "$PSScriptRoot/$repo_src_owner/$devels_playground/$repo_src_name/scripts"
$dir_host_choco = "$PSScriptRoot/$repo_src_owner/$choco/refresh-env"
