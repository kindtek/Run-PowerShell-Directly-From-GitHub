...
$local_dir_scripts = "$repo_src_name/$repo_src_name-temp/scripts"
$local_devels_playground = "$repo_src_name/$repo_src_name-temp/$devels_playground/scripts"
...
$null = New-Item -Path "$repo_src_name/$repo_src_name-temp" -ItemType Directory -Force -ErrorAction SilentlyContinue 
